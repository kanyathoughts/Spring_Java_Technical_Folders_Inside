...
node(executeEnvironmentOn) {
	...
	timestamps {
	    ...
	    def testCases = [
			...
			'testcases.mining.webui.DependencyGraphTest',
			'testcases.mining.webui.ControlFlowGraphTest',
			...
			'testcases.mining.webui.ProjectDashboardTest',
			'testcases.mining.webui.CodeViewerTest',
			'testcases.mining.webui.ConsistentAnnotationEditorTest',
			'testcases.mining.iam.EclipseClientAdminTest',
			'testcases.mining.iam.EclipseProjectManagerTest',
			'testcases.mining.iam.EclipseProjectEditorTest',
			'testcases.mining.iam.EclipseProjectViewerTest',
			'testcases.mining.webui.CallChainReadWriteIdentificationTest',
			'testcases.mining.webui.LargeDependencyGraphTest',
			'testcases.mining.webui.CustomPropertiesTest',
			'testcases.mining.webui.DNAVisualizationTest',
			'testcases.mining.webui.IMSMetricsUITest',
			...
			'testcases.mining.webui.TechnicalTaxonomyCustomizableTableTest',
			'testcases.mining.webui.SharedModuleDetailsViewTest',
			'testcases.mining.webui.ControlFlowGraphPL1Test',
			'testcases.mining.webui.ControlFlowGraphJCLTest',
			'testcases.mining.webui.MetricsUITaxonomyFilterTest',
			'testcases.mining.webui.ControlFlowGraphNaturalTest',

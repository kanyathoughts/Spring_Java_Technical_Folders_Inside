...
/**
 * Transforms the Cobol sources of the customer zero application to Java, using a headless Eclipse.
 *
            ...
            docker.image(dockerUtils.pullJenkinsEnvironmentImage(javaVersion)).inside('-v jenkins-m2-repo:/var/m2_repo:rw') {
                ...
                stage('initialisation') {
					...
					dir("${workDir}/eclipseWorkspace/Test-Project/${tempFolderName}") {
                        ...
                        //prepare expected files for cobol2java
                        sh 'mkdir item-management-mig/expected'
						sh 'mv item-management-mig-automation/Test-Project/expected/src-cobol-java item-management-mig/expected/.'
                ...
                stage('result-comparison') {
                    def actualDir = "${workDir}/eclipseWorkspace/Test-Project/src-cobol-java/innowake/components/source/cobol"
                    def expectedDir = "${workDir}/eclipseWorkspace/Test-Project/expected/src-cobol-java"

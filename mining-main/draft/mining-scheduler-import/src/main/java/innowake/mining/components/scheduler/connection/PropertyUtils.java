...
public class PropertyUtils {
	...
	public static String toString(@Nullable final ProjectData object) {
		...
		try {
			return PojoMapper.jsonWriter().writeValueAsString(new Property(object));
	...
	public static <T> T fromString(final String json, final Class<T> classOfT) throws CoreException {
		try {
			if (StringUtils.isNotBlank(json)) {
				final Property property = JsonUtil.getMapper().readValue(json, Property.class);
	...
	private static class Property {
		...
		private final Long projectIdProperty;
		private final String projectNameProperty;
		private final Long clientIdProperty;
		private final String clientNameProperty;

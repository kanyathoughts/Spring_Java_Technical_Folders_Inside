         MACRO                                                          00001000
&NAME    RFE125 &ENTRY                                                  00002000
         GBLA  &LPREV,&PD,&PX1                                          00003000
         LCLA  &X1,&R1,&R2,&R3,&D,&L,&KVAL,&LWORK                       00004000
         LCLA  &CURL                                                    00005000
         LCLC  &DATA1,&DATA2,&DATA3                                     00006000
         LCLC  &CORP                                                    00007000
*        RFE125 MACRO    *RCIF*                                   2.0   00008000
         TITLE 'COMMERCIAL TABLE'                                       00009000
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 00025000
*                                                                     * 00026000
*            C O M M E R C I A L   S U F F I X   T A B L E            * 00027000
*                                                                     * 00028000
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 00029000
         SPACE                                                          00030000
SCOMM    DS    0CL1 -             START OF COMMERCIAL SUFFIX TABLE      00031000
...
&X1      SETA  &X1+1                                                    00038000
         ...
         DC    X'FF' -            END OF NON-INDIVIDUAL SUFFIX TABLE    00040000
         MEXIT                                                          00041000
.PRE1    ANOP                                                           00042000

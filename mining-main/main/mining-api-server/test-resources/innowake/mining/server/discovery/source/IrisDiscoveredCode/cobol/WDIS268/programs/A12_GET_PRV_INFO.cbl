...
106350*
106360     CALL "FDV$ABC"  USING   BY DESCRIPTOR   "PRV_MASTER"
106370                         ACCESS_READ
106380                         ALLOW_READ
...
106410     END-CALL.
106420*
106430     CALL "FDV$ABC"  USING   BY DESCRIPTOR   "PRV_ADDRESS"
106440                         ACCESS_READ
106450                         ALLOW_READ
...
106620*
106630     CALL "FDV$ABC" USING  BY REFERENCE    PRVMSTR_CHANNEL
106640                         PRVMSTR
106650                         KEY0
...
106740                                                      EXIT_STATUS.
106750*
106760     CALL "FDV$ABC" USING  BY REFERENCE    PRVADDR_CHANNEL
106770                         PRVADDR
106780                         KEY0
...
106870                                                      EXIT_STATUS.
106880*
106890     CALL "FDV$ABC" USING  BY REFERENCE    PRVPHON_CHANNEL
106900                         PRVPHON
106910                         KEY0
...
107200*
107210     CALL "FDV$ABC" USING   BY REFERENCE    PRVMSTR_CHANNEL
107220                         OPTION_NO_BYPASS
107230                 GIVING        RETURN_STATUS.
107240 
107250     CALL "FDV$ABC" USING   BY REFERENCE    PRVADDR_CHANNEL
107260                         OPTION_NO_BYPASS
107270                 GIVING        RETURN_STATUS.
107280 
107290     CALL "FDV$ABC" USING   BY REFERENCE    PRVPHON_CHANNEL

         MACRO                                                          00001000
&NAME    RFE105 &ENTRY                                                  00002000
         GBLA  &LPREV,&PD,&PX1                                          00003000
         LCLA  &X1,&R1,&R2,&R3,&D,&L,&KVAL,&LWORK                       00004000
         LCLA  &CURL                                                    00005000
         LCLC  &DATA1,&DATA2,&DATA3                                     00006000
         LCLC  &CORP                                                    00007000
*        RFE105 MACRO    *RCIF*                                   2.0   00008000
         TITLE 'CRF CONNECTOR TABLE'                                    00009000
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 00025000
*                                                                     * 00026000
*                       C O N N E C T O R   T A B L E                 * 00027000
*                                                                     * 00028000
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 00029000
         SPACE                                                          00030000
CONECTOR DS    0CL1 -             START OF CONNECTOR TABLE              00031000
...
&X1      SETA  &X1+1                                                    00038000
         ...
         DC    X'FF' -            END OF CONNECTOR TABLE                00040000
         MEXIT                                                          00041000
.PRE1    ANOP                                                           00042000
...
&PX1     SETA  &X1                                                      00149000
         AIF   ('&DATA1' EQ '&&').ADJ                                   00150000
.GEN1    ANOP                                                           00151000
         DC    YL1(&L)                                                  00152000
         AIF   ('&DATA2' NE '').GEN2                                    00153000
         DC    C'&DATA1 '                                               00154000
         AGO   .P1                                                      00155000
.GEN2    ANOP                                                           00156000
         AIF   ('&DATA3' NE '').GEN3                                    00157000
         DC    C'&DATA1&DATA2 '                                         00158000
         AGO   .P1                                                      00159000
.GEN3    ANOP                                                           00160000
         DC    C'&DATA1&DATA2&DATA3 '                                   00161000
         AGO   .P1                                                      00162000
.ADJ     ANOP                                                           00163000
&L       SETA  &L-1                                                     00164000
         AGO   .GEN1                                                    00165000
.SQERR   MNOTE 1,'FOLLOWING ENTRY OUT OF SEQUENCE'                      00166000
         AGO   .GEN                                                     00167000
.INV     MNOTE 1,'&SYSLIST(&X1) EXCEEDS 20 BYTES'                       00168000
         MNOTE 1,'MACRO TERMINATED'                                     00169000
         MEXIT                                                          00170000
         MEND                                                           00171000

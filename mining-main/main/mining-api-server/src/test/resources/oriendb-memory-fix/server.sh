...
if [ -z "$ORIENTDB_OPTS_MEMORY" ] ; then
    ORIENTDB_OPTS_MEMORY="-Xms12G -Xmx12G"
fi
...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="UNKNOWN@rd9f940b27ed4d81270f947cc3678c820a587b1c6; 2020-12-15 14:54:33+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-3.1.6.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \

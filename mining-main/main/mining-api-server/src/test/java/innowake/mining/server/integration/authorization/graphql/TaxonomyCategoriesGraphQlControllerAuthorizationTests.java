...
import innowake.mining.server.graphql.controller.TaxonomyCategoriesGraphQlController;

/**
 * Authorization tests for {@link TaxonomyCategoriesGraphQlController}.
 */
class TaxonomyCategoriesGraphQlControllerAuthorizationTests extends GraphQlAuthorizationTests {
	...
	private static final String QUERY = "query ($projectId: EntityId!) { taxonomyCategories(projectId: $projectId) { categories { name } } }";

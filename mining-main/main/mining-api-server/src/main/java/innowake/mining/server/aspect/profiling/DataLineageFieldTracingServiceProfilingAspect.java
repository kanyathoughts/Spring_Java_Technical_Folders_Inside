...
/**
 * Aspect which enables profiling of {@link innowake.mining.server.datalineage.fieldtracing.service.FieldTracingService}.
 * <p>
...
public class DataLineageFieldTracingServiceProfilingAspect {
	...
	public DataLineageFieldTracingServiceProfilingAspect() {
	...
	@Pointcut("execution(* innowake.mining.server.datalineage.fieldtracing.service.FieldTracingService.*(..))")
	public void anyMethodOnFieldTracingService() {
		/* pointcut declaration */
	}

	@Around("anyMethodOnFieldTracingService()")

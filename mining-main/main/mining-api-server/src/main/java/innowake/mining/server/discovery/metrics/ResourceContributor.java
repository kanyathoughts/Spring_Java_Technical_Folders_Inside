...
/**
 * Collects virtual resources for the module tab.
 */
public class ResourceContributor implements MetricsContributor {
	
	/**
	 * Returns if this collector can process the given {@link ModelArtifact} in the given
	 * {@link innowake.mining.data.discovery.metrics.MetricsContributor.Phase}.
	 * 

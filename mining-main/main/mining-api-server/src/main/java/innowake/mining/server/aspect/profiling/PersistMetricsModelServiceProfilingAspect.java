...
/**
 * Aspect which enables profiling of {@link innowake.mining.server.discovery.metrics.PersistMetricsModelService}.
 * <p>
...
public class PersistMetricsModelServiceProfilingAspect {

	private static final Logger LOG = LoggerFactory.getLogger(PersistMetricsModelServiceProfilingAspect.class);

	private static final String PROFILING_CATEGORY_PREFIX = "discovery.persistmetricsmodelservice";

	private final ProfilingSession profilingSession;
	private final Profiler profiler;
	
	public PersistMetricsModelServiceProfilingAspect() {
	...
	@Pointcut("execution(* innowake.mining.server.discovery.metrics.PersistMetricsModelService.*(..))")
	public void anyMethodOnPersistMetricsModelService() {
		/* pointcut declaration */
	}

	@Around("anyMethodOnPersistMetricsModelService()")
	public Object profilePersistMetricsModelService(final ProceedingJoinPoint pjp) throws Throwable {
		...
		LOG.trace(() -> "profiling " + methodName + " on PersistMetricsModelService");

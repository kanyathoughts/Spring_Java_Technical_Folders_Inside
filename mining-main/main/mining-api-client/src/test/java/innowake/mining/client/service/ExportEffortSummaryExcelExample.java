...
/**
 * Command line runner to test {@link ExportEffortSummaryExcel}.
 */
public class ExportEffortSummaryExcelExample {
	...
	public static void main(final String[] args) throws IOException {
		...
		LOG.info("export effort summary project with ID 1" + MARK);
		final Result<Tuple2<String, byte[]>> result = service.exportEffortSummaryExcel().setProjectId(EntityId.of(1l)).execute();

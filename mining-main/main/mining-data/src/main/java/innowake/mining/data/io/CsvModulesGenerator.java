...
/**
 * Creates the Modules sheet of a Discovery CSV file.
 */
@Service
public class CsvModulesGenerator extends ModulesGenerator {

	@Nullable
	private CsvGenerator csvGenerator;

	Map<Long, String> createCsv(final EntityId projectId,
			final DiscoveryExportOptions options,
			final CsvGenerator csvGenerator,
			final boolean sorted) throws IOException {
		this.csvGenerator = csvGenerator;
		csvGenerator.createHeader(WorkbookDefinition.SHEET_MODULES);

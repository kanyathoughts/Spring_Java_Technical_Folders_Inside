...
/**
 * Creates the Dependencies sheet of a Discovery CSV file.
 */
@Service
public class CsvDependenciesGenerator extends DependenciesGenerator {
	...
	void createCsv(final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		csvGenerator.createHeader(WorkbookDefinition.SHEET_DEPENDENCIES);

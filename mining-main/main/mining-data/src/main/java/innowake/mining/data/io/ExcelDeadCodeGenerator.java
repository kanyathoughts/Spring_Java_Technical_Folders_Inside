...
/**
 * Creates the Dead Code sheet of a Discovery Excel workbook.
 */
@Service
public class ExcelDeadCodeGenerator extends DeadCodeGenerator {
	...
	void createSheet(final SXSSFWorkbook workbook, final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		final Sheet sheetDefinition = WorkbookDefinition.SHEETS.get(WorkbookDefinition.SHEET_DEAD_CODE);

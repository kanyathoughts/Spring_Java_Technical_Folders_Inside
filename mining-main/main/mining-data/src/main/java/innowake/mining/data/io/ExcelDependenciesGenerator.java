...
/**
 * Creates the Dependencies sheet of a Discovery Excel workbook.
 */
@Service
public class ExcelDependenciesGenerator extends DependenciesGenerator {
	...
	void createSheet(final SXSSFWorkbook workbook, final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		final Sheet sheetDefinition = WorkbookDefinition.SHEETS.get(WorkbookDefinition.SHEET_DEPENDENCIES);

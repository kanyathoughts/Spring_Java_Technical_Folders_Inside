...
/**
 * Creates the Dead Code sheet of a Discovery CSV file.
 */
@Service
public class CsvDeadCodeGenerator extends DeadCodeGenerator {
	...
	void createCsv(final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		csvGenerator.createHeader(WorkbookDefinition.SHEET_DEAD_CODE);

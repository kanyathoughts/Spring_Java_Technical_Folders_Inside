...
/**
 * Creates the Errors sheet of a Discovery Excel workbook.
 */
@Service
public class ExcelErrorsGenerator extends ErrorsGenerator {
	...
	void createSheet(final SXSSFWorkbook workbook, final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		final Sheet sheetDefinition = WorkbookDefinition.SHEETS.get(WorkbookDefinition.SHEET_ERRORS);

...
/**
 * Creates the Type Summary sheet for the Effort Summary CSV file.
 */
@Service
public class CsvTypeSummaryGenerator extends EffortSummaryGenerator {

	@Nullable
	private CsvGenerator csvGenerator;

	/**
	 * Creates the CSV content for the type summary.
	 *
	...
	void createCsv(final EntityId projectId, final CsvGenerator csvGenerator) throws IOException {
		...
		csvGenerator.createHeader(EffortSummaryWorkbookDefinition.SHEET_TYPE_SUMMARY, true);

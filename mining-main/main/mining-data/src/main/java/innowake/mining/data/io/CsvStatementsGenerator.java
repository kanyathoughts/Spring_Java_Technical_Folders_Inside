...
/**
 * Creates the Statements sheet of a Discovery CSV file.
 */
@Service
public class CsvStatementsGenerator extends StatementsGenerator {
	...
	void createCsv(final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		csvGenerator.createHeader(WorkbookDefinition.SHEET_STATEMENTS);

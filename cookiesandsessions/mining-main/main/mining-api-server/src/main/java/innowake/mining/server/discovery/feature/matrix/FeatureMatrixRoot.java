...
public class FeatureMatrixRoot {
	...
	private Set<FeatureMatrix> featureMatrices = new HashSet<>();
	 ...
	 */
	@JsonProperty("featureMatrix")
	public Set<FeatureMatrix> getFeatureMatrices() {
	 ...
	 * Matrix containing the supported features for each technology-type
	 * (Required)
	 * @param featureMatrices set list of features
	 * 
	 */
	@JsonProperty("featureMatrix")
	public void setFeatureMatrices(Set<FeatureMatrix> featureMatrices) {
		this.featureMatrices = featureMatrices;
	}

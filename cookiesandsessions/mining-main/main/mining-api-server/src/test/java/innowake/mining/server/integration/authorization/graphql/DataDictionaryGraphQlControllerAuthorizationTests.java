...
/**
 * Authorization tests for {@link DataDictionaryGraphQlController}.
 */
class DataDictionaryGraphQlControllerAuthorizationTests extends GraphQlAuthorizationTests {
	...
	private static String QUERY = "query ($projectId: Long!) { dataDictionaries(projectId: $projectId) { totalElements } }";

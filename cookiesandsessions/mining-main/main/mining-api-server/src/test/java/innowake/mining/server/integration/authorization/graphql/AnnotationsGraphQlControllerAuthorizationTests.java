...
/**
 * Authorization tests for {@link AnnotationsGraphQlController}.
 */
class AnnotationsGraphQlControllerAuthorizationTests extends GraphQlAuthorizationTests {
	...
	private static String QUERY = "query ($projectId: Long!) { annotations(projectId: $projectId) { totalElements } }";

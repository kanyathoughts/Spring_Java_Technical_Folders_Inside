       ...
       PROCEDURE DIVISION.
           ...
           CALL "Call16Display1A" USING WS-FIELD-A-1.
      * 9c does not exist
           CALL "TEST9c" USING WS-FIELD-A-1.
         
           CALL "Call16Display1A" USING WS-FIELD-A-2.
      * 9c does not exist   
           CALL "TEST9c" USING WS-FIELD-A-2.
         
           CALL "Call16Display1A" USING WS-FIELD-A-3.
      * 9c does not exist   
           CALL "TEST9c" USING WS-FIELD-A-3.
         
           CALL "Call16Display1A" USING WS-FIELD-A-4.
      * 9c does not exist   
           CALL "TEST9c" USING WS-FIELD-A-4.
         
           CALL "Call16Display1A" USING DUMMY, WS-FIELD-B-1.
      * 9c does not exist   
           CALL "TEST9c" USING DUMMY, WS-FIELD-B-1.
         
           CALL "Call16Display1A" USING DUMMY, WS-FIELD-B-2.
      * 9c does not exist   
           CALL "TEST9c" USING DUMMY, WS-FIELD-B-2.
         
           CALL "Call16Display1A" USING DUMMY, WS-FIELD-B-3.
      * 9c does not exist   
           CALL "TEST9c" USING DUMMY, WS-FIELD-B-3.
     
           CALL "Call16Display1A" USING DUMMY, WS-FIELD-B-4.
      * 9c does not exist   

...
/**
 * Creates the Undiscovered sheet of a Discovery Excel workbook.
 */
@Service
public class ExcelUndiscoveredGenerator extends UndiscoveredGenerator {
	...
	void createSheet(final SXSSFWorkbook workbook, final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		final Sheet sheetDefinition = WorkbookDefinition.SHEETS.get(WorkbookDefinition.SHEET_UNDISCOVERED);

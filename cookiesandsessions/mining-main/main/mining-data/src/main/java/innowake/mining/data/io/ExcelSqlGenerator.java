...
/**
 * Creates the SQL sheet of a Discovery Excel workbook.
 */
@Service
public class ExcelSqlGenerator extends SqlGenerator {
	...
	void createSheet(final SXSSFWorkbook workbook, final EntityId projectId, final Map<Long, String> moduleMapping,
		...
		final Sheet sheetDefinition = WorkbookDefinition.SHEETS.get(WorkbookDefinition.SHEET_SQL);

...
/**
 * HTTP REST service for exporting a Discovery Excel workbook.
 */
public class ExportExcel extends AbstractExportService<ExportExcel> {

	/**
	 * The end point for exporting a Discovery Excel workbook.
	 */
	 ...
	 */
	ExportExcel(final ConnectionInfo connectionInfo) {
